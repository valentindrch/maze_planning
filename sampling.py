...
def trial_learning(model, alpha_a0, alpha_a1, alpha_a2, reward_o3):
    ...
    marg_prior = inference.query(nodes, joint=False)
    sampling_alg = Sampler(model, prior)
    sampled_posterior, n_samples = sampling_alg.query(nodes, evidence={'o3': 0})
